    ...
    return = |x| |s| {state = s, value = x},
        ...
        let expect = expect![[r#"
            (module $test
              ...
              (global (;0;) (mut i32) i32.const 0)
              (export "mem" (memory 0))
              (elem (;0;) (i32.const 0) func 0 1 2 3 $__apply_1_0 $__apply_2_0 $__apply_2_1 $__apply_3_0 $__apply_3_2 $__apply_4_3 $f $f_lam_0 $f_lam_1 $f_lam_2 $f_lam_3 $f_lam_4 $f_lam_5 $f_lam_6 $f_lam_7 $f_lam_8 $f_lam_9 $f_lam_10 $f_lam_11 $f_lam_12 $f_lam_13 $f_lam_14 $f_lam_15 $f_lam_16 $f_lam_17 $f_lam_18)
            )"#]];
        expect.assert_eq(&string);
